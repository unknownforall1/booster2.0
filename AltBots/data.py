...
RAID = [
    ...
    "TERI MAA KI CHUT MAI INDIAN RAILWAY",
    "TERI BHEN KA BHOSRA FAARUUU",
    "TERI MAA KI CHUT",
    "TERA BAAP CHKAAAA",
    "Madharjaat",
    "Amavas ki kaali kaali raat me maarunga teri mum ki gori gori gaand👅👅👅👅",
    "TERI AMMI JAA KO CHOD DUNGA",
    "CHUP HO JAA MAHDARJAAT",
    "AAJA TERI JINDEGI SAWAR DU TERI MAA KI CHUT MAZE MAI MAAR DU",
    "TERI DADI KI CHUT MAI  GANDI KA LUND",
    ...
    "TERI BHEN KI CHUT MAI BURJ KALIFA DAAL DU BSDK",
    "SPEED PKDDD",
